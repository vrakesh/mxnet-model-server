...
def run_single_benchmark(jmx, jmeter_args=dict(), threads=100, out_dir=None):
    ...
    if pargs.mms:
        ...
        docker_run_call = "{} run --name {} -p 8080:8080 -p 8081:8081 -v {}:{} -itd {} tail -f /dev/null".format(docker, container, MMS_BASE, DOCKER_MMS_BASE, docker_path)
        ...
        run_process("{} exec -it {} sh -c 'pip uninstall  mxnet-cu92mkl'".format(docker, container), shell=True)
